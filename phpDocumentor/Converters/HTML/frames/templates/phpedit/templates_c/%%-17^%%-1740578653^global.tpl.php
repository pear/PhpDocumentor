...
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'global.tpl', 9, false),array('modifier', 'replace', 'global.tpl', 13, false),)), $this); ?>
<!-- ============ GLOBAL DETAIL =========== -->
...
</strong> (line <span class="linenumber"><?php if ($this->_tpl_vars['globals'][$this->_sections['glob']['index']]['slink']):  echo $this->_tpl_vars['globals'][$this->_sections['glob']['index']]['slink'];  else:  echo $this->_tpl_vars['globals'][$this->_sections['glob']['index']]['line_number'];  endif; ?></span>)
 </h4> 
<h4><i><?php echo $this->_tpl_vars['globals'][$this->_sections['glob']['index']]['global_type']; ?>
 ...
 : <?php echo ((is_array($_tmp=$this->_tpl_vars['globals'][$this->_sections['glob']['index']]['global_value'])) ? $this->_run_mod_handler('replace', true, $_tmp, "\n", "<br />") : smarty_modifier_replace($_tmp, "\n", "<br />")); ?>
</h4>
